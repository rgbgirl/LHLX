...
//		pga_init.gain = ENUM_LH001_55_PGA_PGAGAIN_24;
//	  pga_gain = 24;
...
//    adc_init.ref_sel = ENUM_LH001_55_ADC_REF_2V;
...
//		LH001_55_adc_channel(ENUM_LH001_55_ADCCHP_AIN1,ENUM_LH001_55_ADCCHP_AIN0);		//ADC Measure AIN0 VS AIN1
		LH001_55_adc_channel(ENUM_LH001_55_ADCCHP_TEST,ENUM_LH001_55_ADCCHN_GND);		//test
}
...
REG_DUMP_t reg[] =
{
  {ADDR_LH001_55_CHIPID,0,"ADDR_LH001_55_CHIPID"},
	{ADDR_LH001_55_ADCCHCON,0,"ADCCHCON"},
};
    ...
    {	
			if(data_ready_flag>0)
			{
				...
				if(adc_data & (1<<23))
					...
					dat = (int)(adc_data);
				printf("%d,%d,%f mV\r\n",data_cnt,dat,dat*2500.0/((1<<23)-1)/pga_gain);
			}	 
