...
REG_DUMP_t reg[] =
{
  {ADDR_LH001_55_DACCON,0,"ADDR_LH001_55_DACCON"},
	{ADDR_LH001_55_DACMUX,0,"ADDR_LH001_55_DACMUX"},
	{ADDR_LH001_55_DACCODE0,0,"ADDR_LH001_55_DACCODE0"},
	{ADDR_LH001_55_DACCODE1,0,"ADDR_LH001_55_DACCODE1"},
};
...
int main()
{
  ...
  LH001_55_init();
	...
	//dac output 1.5v
  LH001_55_dac_enable();
  code = LH001_55_dac_mv2code(1500);
  LH001_55_dac_code(code);
